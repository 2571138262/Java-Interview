...
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/zhuliuyingyongjiagou.jpg)
* 1、请求数据存在于缓存
* 2、直接返回
...
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/BIOmodel.jpg)
#### （3）、多路I/O复用模型
##### Select系统调用
###### select函数可以同时监控多个文件描述符的可读可写请情况，当其中的某些文件描述情况可读或者可写时，select方法就会返回可读或者可写的文件描述符个数，也就是selector是负责监听这些文件是否可读或者可写的
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/xitongdiaoyong.jpg)
...
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/sdsjiegou.jpg)
...
#### 底层数据类型基础
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/dicengshujuleixingjichu.jpg)
...
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/expire.jpg)
* 缺点：原子性得不到满足
...
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/bgsave.jpg)
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/CopyonWrite.jpg)
...
### 2、Redis的同步机制
#### （1）、主从同步原理
![Image](https://github.com/2571138262/Java-Interview/blob/master/images-folder/Redistongbujizhi.jpg)
